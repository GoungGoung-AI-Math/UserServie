...
public class ReqImageContent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1992416212898651167L;
   ...
   */
  public ReqImageContent(MessageType type, EncodedImage encodedImage) {
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: encodedImage = (EncodedImage)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static ReqImageContent.Builder newBuilder() {
    return new ReqImageContent.Builder();
  }
   ...
   * @return A new ReqImageContent RecordBuilder
   */
  public static ReqImageContent.Builder newBuilder(ReqImageContent.Builder other) {
    if (other == null) {
      return new ReqImageContent.Builder();
    } else {
      return new ReqImageContent.Builder(other);
    }
  }
   ...
   * @return A new ReqImageContent RecordBuilder
   */
  public static ReqImageContent.Builder newBuilder(ReqImageContent other) {
    if (other == null) {
      return new ReqImageContent.Builder();
    } else {
      return new ReqImageContent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ReqImageContent>
    ...
    private MessageType type;
    private EncodedImage encodedImage;
    private EncodedImage.Builder encodedImageBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ReqImageContent.Builder other) {
      super(other);
      ...
      if (other.hasEncodedImageBuilder()) {
        this.encodedImageBuilder = EncodedImage.newBuilder(other.getEncodedImageBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ReqImageContent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public ReqImageContent.Builder setType(MessageType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ReqImageContent.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ReqImageContent.Builder setEncodedImage(EncodedImage value) {
     ...
     * @return This builder.
     */
    public EncodedImage.Builder getEncodedImageBuilder() {
      if (encodedImageBuilder == null) {
        if (hasEncodedImage()) {
          setEncodedImageBuilder(EncodedImage.newBuilder(encodedImage));
        } else {
          setEncodedImageBuilder(EncodedImage.newBuilder());
        }
      }
    ...
    public ReqImageContent.Builder setEncodedImageBuilder(EncodedImage.Builder value) {
      clearEncodedImage();
    ...
    /**
      ...
      * @return This builder.
      */
    public ReqImageContent.Builder clearEncodedImage() {
      encodedImage = null;
    ...
    public ReqImageContent build() {
      try {
        ...
        if (encodedImageBuilder != null) {
          ...
          record.encodedImage = fieldSetFlags()[1] ? this.encodedImage : (EncodedImage) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;

...
public class AttemptAnalysisRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static AttemptAnalysisRequestAvroModel fromByteBuffer(
   ...
   private java.util.List<ReqContentUnion> contents;
   ...
   */
  public AttemptAnalysisRequestAvroModel(java.lang.Long attemptId, AnalysisType type, java.util.List<ReqContentUnion> contents) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: type = (AnalysisType)value$; break;
    case 2: contents = (java.util.List<ReqContentUnion>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @param value the value to set.
   */
  public void setType(AnalysisType value) {
    this.type = value;
  }
   ...
   */
  public java.util.List<ReqContentUnion> getContents() {
    return contents;
  }
   ...
   * @param value the value to set.
   */
  public void setContents(java.util.List<ReqContentUnion> value) {
    this.contents = value;
  }
   ...
   */
  public static AttemptAnalysisRequestAvroModel.Builder newBuilder() {
    return new AttemptAnalysisRequestAvroModel.Builder();
  }
   ...
   * @return A new AttemptAnalysisRequestAvroModel RecordBuilder
   */
  public static AttemptAnalysisRequestAvroModel.Builder newBuilder(AttemptAnalysisRequestAvroModel.Builder other) {
    if (other == null) {
      return new AttemptAnalysisRequestAvroModel.Builder();
    } else {
      return new AttemptAnalysisRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new AttemptAnalysisRequestAvroModel RecordBuilder
   */
  public static AttemptAnalysisRequestAvroModel.Builder newBuilder(AttemptAnalysisRequestAvroModel other) {
    if (other == null) {
      return new AttemptAnalysisRequestAvroModel.Builder();
    } else {
      return new AttemptAnalysisRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AttemptAnalysisRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(AttemptAnalysisRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(AttemptAnalysisRequestAvroModel other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.attemptId)) {
        this.attemptId = data().deepCopy(fields()[0].schema(), other.attemptId);
    ...
    /**
      ...
      * @return This builder.
      */
    public AttemptAnalysisRequestAvroModel.Builder setAttemptId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AttemptAnalysisRequestAvroModel.Builder clearAttemptId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public AttemptAnalysisRequestAvroModel.Builder setType(AnalysisType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AttemptAnalysisRequestAvroModel.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public AttemptAnalysisRequestAvroModel.Builder setContents(java.util.List<ReqContentUnion> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AttemptAnalysisRequestAvroModel.Builder clearContents() {
      contents = null;
    ...
    public AttemptAnalysisRequestAvroModel build() {
      try {
        ...
        record.type = fieldSetFlags()[1] ? this.type : (AnalysisType) defaultValue(fields()[1]);
        record.contents = fieldSetFlags()[2] ? this.contents : (java.util.List<ReqContentUnion>) defaultValue(fields()[2]);
        return record;
